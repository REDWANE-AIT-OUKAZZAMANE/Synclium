...
export async function GET() {
  const openapiSpec = {
    ...
    servers: [
      {
        url: "https://synclium.com/api/v1",
        description: "Production Web API v1",
      },
      {
        url: "https://synclium.com/api",
        description: "Production Web API (legacy — aliases v1)",
      },
      {
        url: "http://localhost:3000/api/v1",
        description: "Local Next.js Engine v1",
      },
      {
    ...
    paths: {
      ...
      "/extract": {
        get: {
          tags: ["Extraction"],
          summary: "Query remaining extraction quota",
          description: "Returns current quota balance without consuming a request.",
          operationId: "getExtractQuota",
          responses: {
            "200": {
        ...
        post: {
          ...
          responses: {
            ...
            "403": {
              description: "Turnstile bot-challenge verification failed",
              content: {
                "application/json": {
            ...
            "429": {
              description: "Extraction quota exceeded",
              content: {
                "application/json": {
                  schema: { $ref: "#/components/schemas/ErrorResponse" },
                },
      ...
      schemas: {
        ...
        QuotaResponse: {
          ...
          properties: {
            ...
            used: { type: "number" },
            limit: { type: "number" },
            resetInSec: { type: "number" },
            tier: { type: "string", enum: ["anon", "github"] },
